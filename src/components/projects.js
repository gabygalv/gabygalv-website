...
import { Header, Segment, Grid, Button, Label } from 'semantic-ui-react'
import '../App.scss';
      ...
      <Grid.Row columns={2}>
        ...
        <Segment basic style={{ padding: '20px' }}>
          ...
          <p style={{ marginBottom: '10px' }}>
            populargirlpress.com is an e-commerce website designed to market the publications by PGP. This application integrates Shopify with React to create a fun and easy to use site!
          </p>
          <p style={{ marginBottom: '20px' }}>
            This project design was a collaboration between myself and <a href='https://instagram.com/softhouse.studios'>@softhouse.studios on IG</a>, co-creator of Popular Girl Press.
          </p>
          <Button
          ...
          <p>
            <Label className="ui blue circular label" style={{ margin: '5px' }}>React</Label>
            <Label className="ui olive circular label" style={{ margin: '5px' }}>Shopify</Label>
            <Label className="ui pink circular label" style={{ margin: '5px' }}>DaisyUI</Label>
            <Label className="ui gray circular label" style={{ margin: '5px' }}>AWS</Label>
          </p>
        </Segment>
        </Grid.Column>
        <Grid.Column>
       ...
       <Grid.Column>
        <Segment basic style={{ padding: '20px' }}>
          ...
          <p>
            ...
            <Label className="ui olive circular label" style={{ margin: '5px' }}>Node.js</Label>
        ...
        <Grid.Column style={{ display: 'flex', justifyContent: 'space-between' }}>
          <img 
            ...
            alt='Screenshot from my TableVote app showing the <create a party> tab'
          />
          <img 
            src={tvdemo}
            width={'45%'}
            style={{ borderRadius: '8px' }}
            alt='Screen recording showing a demo of how TableVote works'
          />
        </Grid.Column>
      </Grid.Row>
